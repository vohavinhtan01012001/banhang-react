...
export default function SelectStatusPromotion({ status, id, onChange }: PropsSelect) {
  const statusProduct = useSelector((state: RootState) => state.promotion.statusProduct)
